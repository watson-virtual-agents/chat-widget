...
module.exports = {
	 ...
	 * @param {string} config.userID - a non-identifiable (i.e. not a users email address or public user id) unique ID used for tracking in the Engagement Metrics dashboard
