...
var IBMChat = {
   ...
   * @param {string} config.defaultCountry -  optional: Takes a string of a country name to use to help postal code calculation using `request-geolocation-zipcode` layout in context with "Find nearest store" flows.
